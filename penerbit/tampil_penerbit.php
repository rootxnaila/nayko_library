...
<head>
    <meta charset="UTF-8">
    <title>Publishers | Nayko Library</title>
    <style>
...
<body>
    ...
    <div class="navbar">
        ...
        <div>
            ...
            <a href="tampil_penerbit.php">Publishers</a>
        </div>
    </div>
    ...
    <div class="container">
        <div class="page-header">
            <h2>Publishers</h2>
            <a href="tambah_penerbit.php" class="btn-add">+ Add Publisher</a>
        </div>
        ...
        <div class="item-grid">
            ...
            ?>
                <div class="item-card">
                    <h3><?php echo $row['nama_penerbit']; ?></h3>
                    <div class="card-actions">
                        <a href="edit_penerbit.php?id=<?php echo $row['id_penerbit']; ?>" class="btn-edit">Edit</a>
                        <a href="hapus_penerbit.php?id=<?php echo $row['id_penerbit']; ?>" class="btn-delete" onclick="return confirm('Delete this publisher?');">Delete</a>
                    </div>
                </div>
            <?php } ?>
        </div>
