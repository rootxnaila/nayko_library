...
<head>
    <meta charset="UTF-8">
    <title>Edit Publisher | Nayko Library</title>
    <style>
    ...
    <div class="container">
        ...
        <form action="proses_edit.php" method="POST">
            ...
            <div style="margin-top: 10px;">
                <button type="submit" class="btn-submit">Update Publisher</button>
                <a href="tampil_penerbit.php" class="btn-cancel">Cancel</a>
            </div>
        </form>
    </div>
