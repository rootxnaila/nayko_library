...
<head>
    <meta charset="UTF-8">
    <title>Authors | Nayko Library</title>
    <style>
...
<body>
    ...
    <div class="navbar">
        ...
        <div>
            ...
            <a href="tampil_penulis.php">Authors</a>
    ...
    <div class="container">
        <div class="page-header">
            <h2>Authors</h2>
            <a href="tambah_penulis.php" class="btn-add">+ Add Author</a>
        </div>
            ...
            ?>
                <div class="item-card">
                    ...
                    <div class="card-actions">
                        <a href="edit_penulis.php?id=<?php echo $row['id_penulis']; ?>" class="btn-edit">Edit</a>
                        <a href="hapus_penulis.php?id=<?php echo $row['id_penulis']; ?>" class="btn-delete" onclick="return confirm('Delete this author?');">Delete</a>
                    </div>
                </div>
            <?php } ?>
        </div>
